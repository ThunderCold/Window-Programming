...
namespace Practice8 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationRelation_1;
        
        private global::System.Data.DataRelation relationRelation_2;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationRelation_1 = this.Relations["Relation_1"];
            this.relationRelation_2 = this.Relations["Relation_2"];
        }
        ...
        private void InitClass() {
            ...
            this.relationRelation_1 = new global::System.Data.DataRelation("Relation_1", new global::System.Data.DataColumn[] {
                        this.table寶可夢_招式.招式Column}, new global::System.Data.DataColumn[] {
                        this.table招式_屬性_威力.招式Column}, false);
            this.Relations.Add(this.relationRelation_1);
            this.relationRelation_2 = new global::System.Data.DataRelation("Relation_2", new global::System.Data.DataColumn[] {
                        this.table招式_屬性_威力.屬性Column}, new global::System.Data.DataColumn[] {
                        this.table屬性_克制屬性_被克制屬性.屬性Column}, false);
            this.Relations.Add(this.relationRelation_2);
        }
        ...
        public partial class 招式_屬性_威力DataTable : global::System.Data.TypedTableBase<招式_屬性_威力Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public 招式_屬性_威力Row Add招式_屬性_威力Row(寶可夢_招式Row parent寶可夢_招式RowByRelation_1, string 屬性, int 威力) {
                招式_屬性_威力Row row招式_屬性_威力Row = ((招式_屬性_威力Row)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        null,
                        屬性,
                        威力};
                if ((parent寶可夢_招式RowByRelation_1 != null)) {
                    columnValuesArray[0] = parent寶可夢_招式RowByRelation_1[1];
                }
        ...
        public partial class 屬性_克制屬性_被克制屬性DataTable : global::System.Data.TypedTableBase<屬性_克制屬性_被克制屬性Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public 屬性_克制屬性_被克制屬性Row Add屬性_克制屬性_被克制屬性Row(招式_屬性_威力Row parent招式_屬性_威力RowByRelation_2, string 克制屬性, string 被克制屬性) {
                屬性_克制屬性_被克制屬性Row row屬性_克制屬性_被克制屬性Row = ((屬性_克制屬性_被克制屬性Row)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        null,
                        克制屬性,
                        被克制屬性};
                if ((parent招式_屬性_威力RowByRelation_2 != null)) {
                    columnValuesArray[0] = parent招式_屬性_威力RowByRelation_2[1];
                }
        ...
        public partial class 招式_屬性_威力Row : global::System.Data.DataRow {
            ...
            public 寶可夢_招式Row 寶可夢_招式Row {
                get {
                    return ((寶可夢_招式Row)(this.GetParentRow(this.Table.ParentRelations["Relation_1"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["Relation_1"]);
                }
            }
            ...
            public 屬性_克制屬性_被克制屬性Row[] Get屬性_克制屬性_被克制屬性Rows() {
                if ((this.Table.ChildRelations["Relation_2"] == null)) {
                    return new 屬性_克制屬性_被克制屬性Row[0];
                }
                else {
                    return ((屬性_克制屬性_被克制屬性Row[])(base.GetChildRows(this.Table.ChildRelations["Relation_2"])));
                }
            }
        }
        ...
        public partial class 寶可夢_招式Row : global::System.Data.DataRow {
            ...
            public 招式_屬性_威力Row[] Get招式_屬性_威力Rows() {
                if ((this.Table.ChildRelations["Relation_1"] == null)) {
                    return new 招式_屬性_威力Row[0];
                }
                else {
                    return ((招式_屬性_威力Row[])(base.GetChildRows(this.Table.ChildRelations["Relation_1"])));
                }
            }
        }
        ...
        public partial class 屬性_克制屬性_被克制屬性Row : global::System.Data.DataRow {
            ...
            public 招式_屬性_威力Row 招式_屬性_威力Row {
                get {
                    return ((招式_屬性_威力Row)(this.GetParentRow(this.Table.ParentRelations["Relation_2"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["Relation_2"]);
                }
            }
        }
...
namespace Practice8.Database1DataSetTableAdapters {
    ...
    public partial class 招式_屬性_威力TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Practice8.Properties.Settings.Default.Database1ConnectionString;
        }
